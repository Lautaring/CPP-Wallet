...
VentanaPrincipal::VentanaPrincipal( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	Clogo = new wxStaticBitmap( this, wxID_ANY, wxBitmap( wxT("c-logo(64px).png"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
...
VentanaWallet::VentanaWallet( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	Clogo = new wxStaticBitmap( this, wxID_ANY, wxBitmap( wxT("c-logo.ico"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_botonAgregar->SetBitmap( wxBitmap( wxT("boton-mas.png"), wxBITMAP_TYPE_ANY ) );
	...
	m_botonEnviar->SetBitmap( wxBitmap( wxT("boton-menos.png"), wxBITMAP_TYPE_ANY ) );
	...
	// Columns
	m_grilla_transacciones->SetColSize( 0, 88 );
	m_grilla_transacciones->SetColSize( 1, 70 );
	m_grilla_transacciones->SetColSize( 2, 82 );
	m_grilla_transacciones->SetColSize( 3, 108 );
	m_grilla_transacciones->SetColSize( 4, 104 );
	...
	bSizer21->Add( m_grilla_transacciones, 0, wxALL|wxEXPAND, 5 );
