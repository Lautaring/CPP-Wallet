...
class VentanaWallet : public wxFrame
{
	...
	public:
		...
		VentanaWallet( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("C++ wallet"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 974,437 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
